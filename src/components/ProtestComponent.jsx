    ...
    return (
        <div className=" flex mt-10 gap-10 w-full">
            ...
            <div className="bg-blue-50 w-[40%] relative p-6 border border-gray-300 rounded shadow-md col-span-2">
                <div className="absolute left-[-30px]  bg-indigo-950 text-white px-4 py-3 inline-block  rounded mb-4 text-lg font-semibold w-full">
                    বিক্ষোভের নামে লুটপাট নিতান্তই ছোটলোকি
                </div>
                <p className="text-gray-700 mb-4 pt-16 leading-relaxed ">
            ...
            <div className="space-y-6 w-[60%]">
                {[
                    ...
                    <div key={index} className="flex items-start gap-3 border-b pb-2 border-gray-300">
                        ...
                        <div>
                            <h4 className="  text-xl  font-semibold leading-snug hover:underline cursor-pointer">
                                {item}
                            </h4>
                            <p className="text-sm   mt-1">নজরুল ইসলাম</p>
                        </div>
                    </div>
                ))}
            </div>
